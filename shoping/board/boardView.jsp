...
<body>
	...
	<section id="main">
            <h1 style="margin-right: 300px;">CUSTOMER CENTER</h1>
            <h2 id="board_title">문의 사항 게시판</h2>
            
            <div id="view_title_box">
                <span>${Shopingmall.title}</span>
                <span id="info"> <strong>글쓴이 :</strong> ${Shopingmall.name} | 조회 : 208 | ${Shopingmall.date}</span>     
            </div>
            <p id="view_content">
              ${Shopingmall.content}
            </p>
            <img src="${Shopingmall.img}" alt="게시판 이미지" style="width: 500px" />
            <div id="comment_box">
                <p class="font-monospace, fs-3" style="margin: 10px;" >Comment</p>
                <textarea></textarea>
                <button type="button" class="btn btn-secondary" id="ripple" style="margin-top: -110px"><b>댓글쓰기</b></button>
            </div>
            <div id="buttons">
              <a href="/shopingmall/main/inquiry/delete/${Shopingmall.aid}" style=" text-decoration: none; color: black;">삭제</a>
            <a href="/shopingmall/main/inquiry" style=" text-decoration: none; color: black;">목록</a>
            <a href="/shopingmall/main/inquiry/boardWrite" style=" text-decoration: none; color: black;">글쓰기</a>
            </div> 
